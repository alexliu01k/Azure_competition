...
import lief
import logging
from extract_pe import extract_pe
from get_feature_names import get_feature_names

logging.basicConfig(level=logging.DEBUG)
EMBER_MODEL_PATH = 'defender/models/pe_lgbm_new.txt'
...
class EmberModel(object):
    ...
    def __init__(self,
                 ...
                 name: str = 'ember'):
        # load lightgbm model
        self.model = lgb.Booster(model_file=model_gz_path)
        self.thresh = thresh
        self.__name__ = name
    ...
    def predict_proba(self, bytez: bytes) -> float:
        self.features = extract_pe(bytez[0])
